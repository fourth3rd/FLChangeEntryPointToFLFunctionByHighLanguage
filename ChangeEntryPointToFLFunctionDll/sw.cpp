...
char cName[] = "RavidFrameworkD.dll";
int main()
{
	FILE* fp = fopen("RavidFrameworkDOriginal.dll", "rb");//
	...
	if (fp)
	{
		...
		fclose(fp);
		fp = fopen(R"(RavidFrameworkD.dll)", "wb");
		fseek(fp, 0, SEEK_SET);
